...
- **Datos reales de cartera de Mutua NO obtenidos** (coordinación + anonimización pendientes).
...
5. **Sin evaluación en golden set** — métricas de negocio bloqueadas por datos reales de Mutua.
