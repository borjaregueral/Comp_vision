...
> ⏳ **Estado: BLOQUEADO en coordinación con la aseguradora.**
> Esta tarea (T3.1) entrega la **especificación**: criterios, esquema y proceso de
> anonimización. La **obtención de los datos** es coordinación con la aseguradora/Legal.
...
| Fuente | Extracto de cartera de la aseguradora (a coordinar) |
